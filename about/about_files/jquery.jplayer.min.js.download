...
this.element.append(b)}else{f='<embed name="'+this.internal.flash.id+'" id="'+this.internal.flash.id+'" src="'+this.internal.flash.swf+'"';f+=' width="0" height="0" bgcolor="'+this.options.backgroundColor+'"';f+=' quality="high" FlashVars="'+b+'"';f+=' allowScriptAccess="always"';f+=' type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20141219054329/http://www.macromedia.com/go/getflashplayer" />';this.element.append(f)}this.internal.flash.jq=c("#"+this.internal.flash.id);this.internal.flash.jq.css({width:"0px",
...
/*
     FILE ARCHIVED ON 05:43:29 Dec 19, 2014 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  LoadShardBlock: 31.331 (3)
  esindex: 0.011
  captures_list: 51.627
  CDXLines.iter: 15.512 (3)
  PetaboxLoader3.datanode: 48.616 (4)
  exclusion.robots: 0.173
  exclusion.robots.policy: 0.16
  RedisCDXSource: 1.684
  PetaboxLoader3.resolve: 18.048
  load_resource: 56.096
*/